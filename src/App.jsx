...
const NHIE = [
  ...
  "โกหกเจ้านายเพื่อลาหยุด",
  "ร้องไห้ในหนัง",
  "แอบส่องโซเชียลแฟนเก่า",
  "หลับในที่ประชุม",
  "โดดเรียนทั้งวัน",
  "แกล้งป่วยเพื่อไม่ไปทำงาน",
  "เมาแล้วโทรหาแฟนเก่า",
  "ลืมวันเกิดเพื่อนสนิท",
  "เต้นบนโต๊ะในร้านเหล้า",
  "ปลอมโปรไฟล์เดตติ้งแอป",
  "แอบกินของในตู้เย็นเพื่อนร่วมห้อง",
];
...
const MOST_LIKELY = [
  ...
  "เป็นเจ้านายที่ดุที่สุดถ้าได้เป็นหัวหน้า",
...
const KING_RULES = {
  ...
  "9": "พูดคำว่า 'ปุ๊ก' ใครพูดช้าสุดดื่ม",
